...
(function (exports) {
	...
	var AxiosHeaders$1 = /*#__PURE__*/function () {
	  function AxiosHeaders$1(headers) {
	    babelHelpers.classCallCheck(this, AxiosHeaders$1);
	    headers && this.set(headers);
	  }
	  babelHelpers.createClass(AxiosHeaders$1, [{
	    key: "set",
	...
	var xhrAdapter = isXHRAdapterSupported && function (config) {
	  return new Promise(function dispatchXhrRequest(resolve, reject) {
	    ...
	    var requestHeaders = AxiosHeaders$2.from(config.headers).normalize();
	...
	var headersToObject = function headersToObject(thing) {
	  return thing instanceof AxiosHeaders$2 ? thing.toJSON() : thing;
	};
	...
	var Axios$1 = /*#__PURE__*/function () {
	  function Axios$1(instanceConfig) {
	    babelHelpers.classCallCheck(this, Axios$1);
	   ...
	   * @returns {Promise} The Promise to be fulfilled
	   */
	  babelHelpers.createClass(Axios$1, [{
	    key: "request",
	...
	var CancelToken$1 = /*#__PURE__*/function () {
	  function CancelToken$1(executor) {
	    babelHelpers.classCallCheck(this, CancelToken$1);
	   ...
	   * Throws a `CanceledError` if cancellation has been requested.
	   */
	  babelHelpers.createClass(CancelToken$1, [{
	...
	Object.entries(HttpStatusCode$1).forEach(function (_ref7) {
...
}((this.BX.Vue3.Axios = this.BX.Vue3.Axios || {})));
